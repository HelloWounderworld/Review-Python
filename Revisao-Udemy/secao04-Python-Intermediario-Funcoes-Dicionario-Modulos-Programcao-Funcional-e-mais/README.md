...
## Aula 89 e 90 - Exercício e Solução - Lista de tarefas com opções de desfazer e refazer:
Seguir o enunciado
...
# Revisão:
Antes de seguir para a próxima seção, recomendamos que vc faça uma revisão do que foi abordado dentro dessa revisão!
