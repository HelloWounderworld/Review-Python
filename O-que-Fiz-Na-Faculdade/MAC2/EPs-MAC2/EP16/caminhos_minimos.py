...
Caminhos_Minimos(Grafo('grafo.txt'), 'A') explodiu: 'Grafo' object has no attribute 'vertice'
...
Caminhos_Minimos(Grafo('routes.txt'), 'JFK') explodiu: 'Grafo' object has no attribute 'vertice'
não passou no(s) teste(s) acima
Grafo('routes.txt'): avaliação encerrada... (nota 0)

Grafo('grafoX.txt'): iniciando avaliação (vale 3 ponto(s))
Caminhos_Minimos(Grafo('grafoX.txt'), 'A') explodiu: 'Grafo' object has no attribute 'vertice'
não passou no(s) teste(s) acima
