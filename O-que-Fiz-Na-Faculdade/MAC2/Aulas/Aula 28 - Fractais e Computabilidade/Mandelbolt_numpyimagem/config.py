# para mandelbrot.py e mandelbrot-anim.py
if 0:
    N   = 256
else:
    N   = 512 # tamanho da imagem 512x512 pixels
MAX  = 255  # número máximo de iterações
COLOR_MAP = "gray" # color map default


# TRY https://matplotlib.org/users/colormaps.html
# COLOR_MAP = "viridis"
# COLOR_MAP = "terrain"
# COLOR_MAP = "plasma"
# COLOR_MAP = "magma"
...
# para mandelbrot-anim.py
ZOOM = 1.015 # passo para a animação: a cada iteração fazemos um "pequeno" 
             # zoom
# FRAMES = 720
