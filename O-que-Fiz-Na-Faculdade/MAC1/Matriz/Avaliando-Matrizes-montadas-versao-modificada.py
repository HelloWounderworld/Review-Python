...
def main():
    ...
    Stop = ""
    while (Stop != "Nao"):
         n = str(input("Entre com um elemento ou digite 'Fim': "))
         m = float(n)
         if(n != "Fim"):# Aqui esta com erro. Verifique !
             if(type(m) != str):
                 sub_lista.append(m)
                 print("Mostre-me a sublista que esta sendo montada: ", sub_lista)
             else:
                 sub_lista.append(n)
                 print("Mostre-me a sublista que esta sendo montada: ", sub_lista)
             ...
             c.append(sub_lista)
             print("Mostre-me a matriz que esta sendo montada: ", c)
             sub_lista = []
             Stop = str(input("Voce deseja continuar montando a matriz 'Sim' ou 'Nao'?\nDigite a opçao desejada: "))
             while(Stop != "Sim" and Stop != "Nao"):
                 Stop = str(input("Voce deseja continuar montando a matriz 'Sim' ou 'Nao'?\nDigite a opçao desejada: "))
